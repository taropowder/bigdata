...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
            <a class="btn btn-primary radius" data-title="添加" data-href="school-add.html"  onclick="Hui_admin_tab(this)" href="school-add.html"><i class="Hui-iconfont">&#xe600;</i> 添加</a>
		</span>
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            $sql="SELECT id,title,time FROM school where id IS NOT NULL ";
            $res= $mysqli->execute_dql($sql);
            ...
            if($dataCount)
            {
                ...
                for ($i = 0; $i <$dataCount; $i++) {
                    ...
                    echo "<td>$id</td>";
                    echo "<td>$name</td>";
                    echo "<td><a href='../school/school.php?id=$id'>点击查看</a></td>";

                    echo "<td>$time</td>";
                    echo"<td > <a  href='school-delect.php?id=$id'>删除</a></td>";
                    echo"</tr>";
                }
                echo"</tbody>";
            }
