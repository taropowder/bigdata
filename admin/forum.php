...
$sql = "SELECT id,title,user,time,question from question order by id desc";
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            if($datacount)
            {
                ...
                for ($i = 0; $i <$datacount; $i++) {
                    ...
                    echo "<td>$name</td>";
                    //echo"</td><td><img src='$icon'></td>";
                    echo "<td><a href='forum-view.php?id=$id'>$icon</a></td>";
                    echo "<td>$time</td>";
                    echo"<td > <a  href='forum-delect.php?id=$id'>删除</a></td>";
                    echo"</tr>";
                }
                echo"</tbody>";
            }
